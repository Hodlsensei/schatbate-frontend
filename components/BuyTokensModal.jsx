...
const IcoShield  = () => (<svg width="20" height="20" viewBox="0 0 24 24" fill="#4caf50"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"/></svg>);
const IcoEncrypt = () => (<svg width="20" height="20" viewBox="0 0 24 24" fill="#4caf50"><path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zM12 17c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM9 8V6c0-1.66 1.34-3 3-3s3 1.34 3 3v2H9z"/></svg>);
const IcoPrivacy = () => (<svg width="20" height="20" viewBox="0 0 24 24" fill="#4caf50"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14H9V8h2v8zm4 0h-2V8h2v8z"/></svg>);
...
// ── individual logo box with white background ─────────────────────────────────
...
// ── Card logos — each with white background ───────────────────────────────────
const CardLogos = () => (
  <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:4 }}>
    {/* VISA */}
    <LogoBox width={44}>
      <svg width="34" height="14" viewBox="0 0 34 14">
        <text x="0" y="12" fontSize="13" fontWeight="900" fill="#1a1f71" fontFamily="Arial,sans-serif">VISA</text>
      </svg>
    </LogoBox>
    {/* Mastercard */}
    <LogoBox width={44}>
      <svg width="36" height="22" viewBox="0 0 36 22">
        ...
        <path d="M18 4.5C19.7 5.9 20.7 8 20.7 11s-1 5.1-2.7 6.5C16.3 16.1 15.3 14 15.3 11s1-5.1 2.7-6.5z" fill="#ff5f00"/>
      </svg>
    </LogoBox>
    {/* Maestro */}
    <LogoBox width={44}>
      <svg width="36" height="22" viewBox="0 0 36 22">
        ...
        <circle cx="23" cy="11" r="10" fill="#e31837" opacity="0.9"/>
        <path d="M18 4.5C19.7 5.9 20.7 8 20.7 11s-1 5.1-2.7 6.5C16.3 16.1 15.3 14 15.3 11s1-5.1 2.7-6.5z" fill="#6c2ecc" opacity="0.7"/>
      </svg>
    </LogoBox>
    {/* Discover */}
    <LogoBox width={44}>
      <svg width="40" height="22" viewBox="0 0 40 22">
        <text x="1" y="10" fontSize="6.5" fontWeight="700" fill="#231f20" fontFamily="Arial,sans-serif">DISCOVER</text>
        <circle cx="30" cy="14" r="7" fill="#f76f20"/>
      </svg>
    </LogoBox>
  </div>
);

// ── Crypto logos — matching the exact image (BTC gold, ETH purple, USDT green in circle badges) ──
const CryptoLogos = () => (
  <div style={{ background:"#fff", borderRadius:6, padding:"4px 8px", display:"flex", alignItems:"center", gap:4 }}>
    {/* BTC - gold circle with B */}
    <div style={{ width:22, height:22, borderRadius:"50%", background:"linear-gradient(135deg,#f7931a,#e07b10)", display:"flex", alignItems:"center", justifyContent:"center" }}>
      <span style={{ color:"#fff", fontSize:11, fontWeight:900, fontFamily:"Arial" }}>₿</span>
    </div>
    {/* ETH - blue/purple circle with diamond */}
    <div style={{ width:22, height:22, borderRadius:"50%", background:"linear-gradient(135deg,#627eea,#4a5dc7)", display:"flex", alignItems:"center", justifyContent:"center" }}>
      <svg width="12" height="14" viewBox="0 0 12 14">
        <polygon points="6,0 12,7 6,9 0,7" fill="rgba(255,255,255,0.9)"/>
        <polygon points="6,10 12,7 6,14 0,7" fill="rgba(255,255,255,0.6)"/>
      </svg>
    </div>
    {/* USDT - green circle with T */}
    <div style={{ width:22, height:22, borderRadius:"50%", background:"linear-gradient(135deg,#26a17b,#1a7a5c)", display:"flex", alignItems:"center", justifyContent:"center" }}>
      <span style={{ color:"#fff", fontSize:11, fontWeight:900, fontFamily:"Arial" }}>₮</span>
    </div>
  </div>
);
...
const PaypalLogo = () => (
  <LogoBox width={72}>
    <svg width="58" height="18" viewBox="0 0 58 18">
      <text x="0" y="14" fontSize="14" fontWeight="900" fill="#003087" fontFamily="Arial,sans-serif">Pay</text>
      <text x="22" y="14" fontSize="14" fontWeight="900" fill="#009cde" fontFamily="Arial,sans-serif">Pal</text>
    </svg>
  </LogoBox>
);
const SkrillLogo = () => (
  <LogoBox width={60}>
    <svg width="46" height="18" viewBox="0 0 46 18">
      <text x="1" y="14" fontSize="13" fontWeight="700" fill="#892cd2" fontFamily="Arial,sans-serif">Skrill</text>
    </svg>
  </LogoBox>
);
const PayAttitudeLogo = () => (
  <LogoBox width={88}>
    <svg width="76" height="16" viewBox="0 0 76 16">
      <text x="1" y="12" fontSize="10" fontWeight="700" fill="#e63946" fontFamily="Arial,sans-serif">payAttitude</text>
    </svg>
  </LogoBox>
);
const BankLogo = () => (
  <LogoBox width={44}>
    <svg width="24" height="22" viewBox="0 0 24 22" fill="#2ecc71">
      <path d="M12 0L1 5v2h22V5L12 0zM3 9v8H1v2h22v-2h-2V9h-3v8h-4V9H9v8H6V9H3z"/>
    </svg>
  </LogoBox>
);
...
const SecurityBadges = () => (
  <div style={{ padding:"14px 28px 20px", borderTop:"1px solid #2a2a2a", display:"flex", alignItems:"center", justifyContent:"center", gap:36, flexWrap:"wrap" }}>
    <div style={{ display:"flex", alignItems:"center", gap:8 }}><IcoShield/><div><div style={{ fontSize:11, fontWeight:700, color:"#fff" }}>COMODO</div><div style={{ fontSize:10, color:"#888" }}>SECURE</div></div></div>
    <div style={{ display:"flex", alignItems:"center", gap:8 }}><IcoEncrypt/><div><div style={{ fontSize:11, fontWeight:700, color:"#fff" }}>256 bit</div><div style={{ fontSize:10, color:"#888" }}>SSL ENCRYPTION</div></div></div>
    <div style={{ display:"flex", alignItems:"center", gap:8 }}><IcoPrivacy/><div><div style={{ fontSize:11, fontWeight:700, color:"#fff" }}>PRIVACY</div><div style={{ fontSize:10, color:"#888" }}>in bank statement</div></div></div>
  </div>
);

// ── STEP 1 ────────────────────────────────────────────────────────────────────
function Step1({ selectedPayment, setSelectedPayment, selectedPackage, setSelectedPackage, showAll, setShowAll, onContinue }) {
  const visible = showAll ? tokenPackages : tokenPackages.slice(0, 3);

  return (
    <div>
      {/* Hero */}
      <div style={{ display:"flex", alignItems:"center", gap:16, padding:"20px 28px", borderBottom:"1px solid #2a2a2a" }}>
        <CoinStack/>
        <div>
          <div style={{ fontSize:18, fontWeight:700, color:"#fff", marginBottom:4 }}>Get tokens to enjoy perks!</div>
          <div style={{ fontSize:13, color:"#999" }}>Tip models, watch <span style={{ color:"#e5342a" }}>Private</span> and <span style={{ color:"#e5342a" }}>Spy</span> shows, unlock exclusive content and more!</div>
        </div>
      </div>

      {/* Two columns — equal height, side by side */}
      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", minHeight:420 }}>

        {/* LEFT: Payment Methods */}
        <div style={{ padding:"24px 28px", borderRight:"1px solid #2a2a2a" }}>
          <div style={{ fontSize:14, fontWeight:700, color:"#fff", marginBottom:14 }}>Payment Method</div>
          <div style={{ display:"flex", flexDirection:"column", gap:9 }}>
            {paymentMethods.map(pm => (
              <div key={pm.id}
                onClick={() => setSelectedPayment(pm.id)}
                style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"12px 16px", borderRadius:8, cursor:"pointer", border: selectedPayment===pm.id ? "1.5px solid #4caf50" : "1px solid #2e2e2e", background: selectedPayment===pm.id ? "rgba(76,175,80,0.08)" : "#222", transition:"all .12s" }}
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:9 }}>
            {visible.map(pkg => (
              <div key={pkg.id}
                ...
                style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"13px 16px", borderRadius:8, cursor:"pointer", border: selectedPackage===pkg.id ? "1.5px solid #c0392b" : "1px solid #2e2e2e", background: selectedPackage===pkg.id ? "rgba(120,0,0,0.35)" : "#222", transition:"all .12s" }}
      ...
      {/* Continue */}
      <div style={{ padding:"18px 28px 12px", borderTop:"1px solid #2a2a2a", display:"flex", flexDirection:"column", alignItems:"center", gap:10 }}>
        <button onClick={onContinue}
          style={{ width:"min(340px,100%)", padding:"14px 0", borderRadius:30, background:"linear-gradient(135deg,#6abf45,#3a8c1c)", border:"none", color:"#fff", fontSize:16, fontWeight:700, cursor:"pointer", fontFamily:"inherit" }}
        ...
        <div style={{ display:"flex", alignItems:"center", gap:6, fontSize:12, color:"#666" }}>
          <IcoLock/>
          <span>This is a one-time-only offer. You will be securely billed once. <span style={{ color:"#4caf50" }}>No recurring charges.</span></span>
        </div>
      </div>
...
function Step2({ pkg }) {
  ...
  return (
    <div style={{ padding:"32px 28px", display:"flex", flexDirection:"column", alignItems:"center" }}>
      {/* Summary */}
      <div style={{ display:"flex", alignItems:"center", gap:16, marginBottom:28, width:"100%", maxWidth:560, padding:"18px 22px", background:"rgba(255,255,255,0.04)", borderRadius:10 }}>
        <CoinStack/>
        <div>
      ...
      <div style={{ width:"100%", maxWidth:380 }}>
        ...
        {/* Continue */}
        <button style={{ width:"100%", padding:"14px 0", borderRadius:30, background: verified?"linear-gradient(135deg,#6abf45,#3a8c1c)":"#2a2a2a", border:"none", color: verified?"#fff":"#555", fontSize:16, fontWeight:700, cursor: verified?"pointer":"not-allowed", fontFamily:"inherit", marginBottom:16, transition:"all .2s" }}>
          Continue
        </button>
...
// ── MAIN EXPORT ───────────────────────────────────────────────────────────────
export default function BuyTokensModal({ onClose }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"14px 24px", borderBottom:"1px solid #2a2a2a", flexShrink:0 }}>
          {step === 2 ? (
            <button onClick={() => setStep(1)} style={{ background:"none", border:"none", cursor:"pointer", color:"#aaa", fontSize:13, display:"flex", alignItems:"center", gap:6, padding:0, fontFamily:"inherit" }}
          ...
          <button onClick={onClose} style={{ background:"none", border:"none", cursor:"pointer", padding:6, display:"flex", borderRadius:"50%" }}
